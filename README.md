...
- Panel separado `admin.html` para subir y editar cursos con foto, tareas, usuarios, inventario de compras y cupones.
- Paginas individuales para inicio, aprendizaje, cursos, perfil y certificados.
- Pagina individual `curso.html` para cada curso, con documentos desbloqueados por cupon de un solo uso.
- Pagina `tareas.html` para que alumnos logueados vean documentos PDF, Word o Excel subidos por el administrador.
- Entrega de trabajos: el alumno sube su documento y el admin lo descarga para corregir.
- Tienda de cursos con compra por WhatsApp: `939-206-3234`.
- Certificados imprimibles o guardables como PDF al completar un curso con un cupon valido.
